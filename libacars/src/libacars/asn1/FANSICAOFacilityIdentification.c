...
static asn_per_constraints_t asn_PER_type_FANSICAOFacilityIdentification_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_FANSICAOFacilityIdentification_1[] = {
...
static asn_CHOICE_specifics_t asn_SPC_FANSICAOFacilityIdentification_specs_1 = {
