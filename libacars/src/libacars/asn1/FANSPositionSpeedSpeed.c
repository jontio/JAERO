...
static const ber_tlv_tag_t asn_DEF_FANSPositionSpeedSpeed_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_FANSPositionSpeedSpeed_tag2el_1[] = {
...
static asn_SEQUENCE_specifics_t asn_SPC_FANSPositionSpeedSpeed_specs_1 = {
	sizeof(struct FANSPositionSpeedSpeed),
	offsetof(struct FANSPositionSpeedSpeed, _asn_ctx),
	asn_MAP_FANSPositionSpeedSpeed_tag2el_1,
	6,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	-1,	/* Start extensions */
	-1	/* Stop extensions */
};
asn_TYPE_descriptor_t asn_DEF_FANSPositionSpeedSpeed = {
	...
	asn_DEF_FANSPositionSpeedSpeed_tags_1,
	sizeof(asn_DEF_FANSPositionSpeedSpeed_tags_1)
		/sizeof(asn_DEF_FANSPositionSpeedSpeed_tags_1[0]), /* 1 */
	asn_DEF_FANSPositionSpeedSpeed_tags_1,	/* Same as above */
	sizeof(asn_DEF_FANSPositionSpeedSpeed_tags_1)
		/sizeof(asn_DEF_FANSPositionSpeedSpeed_tags_1[0]), /* 1 */
	0,	/* No PER visible constraints */
	asn_MBR_FANSPositionSpeedSpeed_1,
	2,	/* Elements count */
	&asn_SPC_FANSPositionSpeedSpeed_specs_1	/* Additional specs */
};
